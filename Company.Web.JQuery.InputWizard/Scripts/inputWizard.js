(function ($) {
    ...
    $.inputWizard = function (element, options) {
    ...
    $.fn.inputWizard = function (options) {

        return this.each(function () {
            if (undefined == $(this).data('inputWizard')) {
                var plugin = new $.inputWizard(this, options);
                $(this).data("inputWizard", plugin);
            }
        });
    ...
    $.fn.inputWizard.setSearchCache = function (term, results) {
        searchCache[term] = results;
    }

    $.fn.inputWizard.getSearchCache = function (term) {
